...
const parsedDistritos = mapa.objects['departamentos-buenos_aires'].geometries.map(i => ({ ...i, properties: { ...i.properties, seccion_electoral: finder(i.properties.departamento) ?? 9 } }))
